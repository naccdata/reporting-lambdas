...
- [ ] 1. Implement content-based upsert in Checkpoint
  - [ ] 1.1 Add IDENTITY_COLUMNS constant and update add_events method
  ...
  - [ ] 1.3 Write property test: Upsert Completeness
  ...
  - [ ] 1.5 Write property test: Correction Replacement
  ...
  - [ ] 1.7 Write property test: Sort Invariant
